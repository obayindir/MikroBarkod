...
{
    public partial class FrmFasondanGiris : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmFasondanGiris (string evrakSeri, int evrakSira)
        {
            InitializeComponent();
            gridControl1.DataSource = grid;

            if (repository.CheckKayitVarmi(evrakSeri, evrakSira, "12"))
            {
                STOK_HAREKETLERI ss = repository.GetSthSeriSira(evrakSeri, evrakSira, "12");
                ...
                grid.Clear();
                List<STOK_HAREKETLERI> gridItem = (List<STOK_HAREKETLERI>)repository.GetAllSthWSeriSira(evrakSeri, evrakSira, "12");
        ...
        private void FrmFasondanGiris_Load(object sender, EventArgs e)
        {
